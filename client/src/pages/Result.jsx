    ...
    <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]'>
      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm '>
        ...
        <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-8'>
          <button className='px-8 py-2.5 border text-violet-600 text-sm border-violet-600 rounded-full hover:scale-105 transition-all duration-700'>Try another image</button>
